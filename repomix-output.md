...
````json
{
  "permissions": {
    "allow": [
      ...
      "Bash(grep -E \"^\\\\.\\(playwright|vscode|claude\\)|^mock-server|^Assistant|\\\\.png$|refactor_opus|spartan_plan|ui_changes|\\\\.mcp\")",
      "Bash(sed -n '12,35p' src/app/core/models/event.model.ts)",
      "Bash(sed -n '68,90p' src/app/core/api/api-mappers.ts)",
      "Bash(npx playwright *)",
      "Bash(playwright-cli tracing-start *)",
      "Bash(playwright-cli tracing-stop *)",
      "Bash(ng test *)",
      "Bash(echo \"Exit: $?\")",
      "Bash(sed 's/\\\\.ts$//')",
      "Bash(grep -E \"\\\\.ts$|\\\\.js$|\\\\.json$\")",
      "Bash(vercel ls *)",
      "Bash(npx vercel@latest ls)",
      "Bash(playwright-cli go-back *)",
      "Bash(playwright-cli cookie-list *)",
      "Bash(playwright-cli -s=incognito open https://book-club-kkufw3442-dmytros-projects-ad22eb22.vercel.app/clubs)",
      "Bash(playwright-cli -s=incognito snapshot)",
      "Bash(playwright-cli -s=incognito close)"
    ]
  },
